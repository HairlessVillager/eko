export class ChromeProxyHolder {

  // Create a proxy class for Chrome
  private static innerChromeProxy: any = null;
  private static magic: number = 0;
   ...
   */
  public static setChromeProxy(chromeProxy: any): void {
    console.log("debug setChromeProxy()...");
    console.log(chrome);
    console.log(chromeProxy);
    console.log(this.magic);
    this.magic = 1;
    console.log(this.magic);
    console.log("debug setChromeProxy()...done");

    this.innerChromeProxy = new Proxy(chrome, {
   ...
   */
  public static getChromeProxy(): any {
    console.log("debug getChromeProxy()...");
    console.log(this.magic);
    this.magic = 2;
    console.log(this.magic);
    if (this.innerChromeProxy) {
      console.log("return proxy");
      console.log(this.innerChromeProxy);
      console.log("debug getChromeProxy()...done");
      return this.innerChromeProxy;
    } else {
      console.log("return original chrome");
      console.log("debug getChromeProxy()...done");
      return chrome;
    }
  }
