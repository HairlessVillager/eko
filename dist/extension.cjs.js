...
function getCurrentTabId(chromeProxy, windowId) {
    return new Promise((resolve, reject) => {
        chromeProxy.tabs.query({ windowId, active: true, lastFocusedWindow: true }, function (tabs) {
            ...
            if (tabs.length > 0) {
                ...
                chromeProxy.tabs.query({ windowId, active: true, currentWindow: true }, function (_tabs) {
                    if (_tabs.length > 0) {
                        resolve(_tabs[0].id);
                        return;
                    }
                    else {
                        chromeProxy.tabs.query({ windowId, status: 'complete', currentWindow: true }, function (__tabs) {
...
class SummaryWorkflow {
    ...
    async execute(context, params) {
        ...
        await ((_c = (_a = context.callback) === null || _a === void 0 ? void 0 : (_b = _a.hooks).onSummaryWorkflow) === null || _c === void 0 ? void 0 : _c.call(_b, params.summary));
        return { status: "OK" };
    }
}
